...
export default function MediumCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setProfile_name(initialValues.profile_name);
    setArticle_title(initialValues.article_title);
    setPub_date(initialValues.pub_date);
    setArticle_url(initialValues.article_url);
    setViews(initialValues.views);
    setComments(initialValues.comments);
    setEngagement_rate(initialValues.engagement_rate);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Medium(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MediumCreateForm")}
      {...rest}
    >
      <TextField
        label="Profile name"
