...
export default function MediumUpdateForm(props) {
  const {
    id: idProp,
    medium: mediumModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = mediumRecord
      ? { ...initialValues, ...mediumRecord }
      : initialValues;
  ...
  const [mediumRecord, setMediumRecord] = React.useState(mediumModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Medium, idProp)
        : mediumModelProp;
      setMediumRecord(record);
    };
    queryData();
  }, [idProp, mediumModelProp]);
  React.useEffect(resetStateValues, [mediumRecord]);
  const validations = {
    profile_name: [{ type: "Required" }],
    article_title: [{ type: "Required" }],
    pub_date: [{ type: "Required" }],
    article_url: [{ type: "Required" }, { type: "URL" }],
    views: [],
    comments: [],
    engagement_rate: [],
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Medium.copyOf(mediumRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "MediumUpdateForm")}
      {...rest}
    >
      <TextField
        label="Profile name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || mediumModelProp)}
